...
public class rock { // Esta clase representa las rocas que tiene que esquivar nuestro pingüino.
	...
	public void update(int punt) { // Función que se ejecuta en Render de GameScren, y sirve para actualizar los valores de las rocas.
		posicion.y = posicion.y + SPEED + (punt/3); // Se mueven hacia arriba en la pantalla
